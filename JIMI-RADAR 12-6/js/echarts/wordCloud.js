            ...
            var i = function () {
                ...
                if (i) {
                    for (var t, e, r = document.createElement("canvas").getContext("2d"), n = 20; n;) {
                        if (r.font = n.toString(10) + "px sans-serif", r.measureText("£×").width === t && r.measureText("m").width === e)return n + 1;
                        t = r.measureText("£×").width, e = r.measureText("m").width, n--
                    }
                    return 0
                }
            }(), u = function (t) {
                ...
                if (i) {
                    ...
                    var n = {
                        list: [],
                        fontFamily: '"Trebuchet MS", "Heiti TC", "Î¢Ü›ÕýºÚów", "Arial Unicode MS", "Droid Fallback Sans", sans-serif',
                        fontWeight: "normal",
                        color: "random-dark",
                        minSize: 0,
                        weightFactor: 1,
                    ...
                    var b, S = !1, C = [], I = function (t) {
                        ...
                        var s = l.measureText(t).width / u, f = Math.max(i * u, l.measureText("m").width, l.measureText("£×").width) / u, h = s + 2 * f, d = 3 * f, g = Math.ceil(h / p), m = Math.ceil(d / p);
                        h = g * p, d = m * p;
